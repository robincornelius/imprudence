...
LLPluginProcessChild::LLPluginProcessChild()
{
	...
	mInstance = NULL;
	//FIXME mSocket = LLSocket::create(gAPRPoolp, LLSocket::STREAM_TCP);
...
{
	 mPort = launcher_port;
	//FIXME mLauncherHost = LLHost("127.0.0.1", launcher_port);
		...
		switch(mState)
		{
			...
			case STATE_INITIALIZED:
	
				{
					...
					LLPluginMessagePipe * p = new LLPluginMessagePipe(this,mPort);
					if(p->mSocket>0)
					{
